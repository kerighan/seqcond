...
def iterate_synth(
    ...
    if extra_data:
        ...
        def _make_extra_iter(epoch_num):
            ...
            ds = ds.shuffle(seed=12801 + epoch_num, buffer_size=100_000)
            if process_count > 1:
    ...
    dataset = dataset.shuffle(seed=12801, buffer_size=100_000)
        ...
        while not epoch_done:
            ...
            try:
                for item in dataset:
                    ...
                    if extra_iter is not None and extra_rng.random() < 0.18:
                        try:
